export const CONTENT = {
  ...
  BUTTON_ENTER: "Войти",
  OFERTA_TEXT:
    "Нажимая на кнопку “Войти” вы соглашаетесь, что расчет налогов будет производиться только на основании данных, успешно загруженных в сервис. Вы принимаете ",
  OFERTA_LINK_TWO: "обработку персональных данных.",
  OFERTA_LINK_ONE: "условия оферты",
  TEXT_AND: ", соглашаетесь на ",
  NAME: "Название",
  ...
  OFERTA_REGISTER_ONE: "Нажимая на кнопку “Продолжить” вы принимаете условия ",
  OFERTA_LINK: "оферты,",
  PERSONAL_DATA_LINK: "обработку персональных данных",
  OFERTA_REGISTER_TWO: " соглашаетесь на ",
